    ...
    return( 
        <div className="md:w-[50%] p-4 md:bg-gray-300 lg:rounded-md bg-gray-50">
            ...
            <div className="italic pt-2 space-y-2">
                ...
                <p>Cuando empecé en el mundo de la programación descubrí lo amplio y bonito que es este mundo.</p>
                <p>Me encanta invesigar, descubrir y conocer nuevas tecnologias.</p>
            </div>
        </div>
    )
